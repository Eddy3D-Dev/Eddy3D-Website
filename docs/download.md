...
- **Current version:** `1.1.0.827` (July 15, 2026)
...
| --- | --- | --- | --- | --- | --- | --- |
| Stable release | `1.1.0.827` | July 15, 2026 | Windows / Mac | 8.27 | [Install via Rhino Package Manager](https://rhinopackages.github.io/?search=eddy3d&sort=2&p=Eddy3D){ aria-label="Install Eddy3D 1.1.0.827 via the Rhino Package Manager" } | [Changelog](#changelog) |
