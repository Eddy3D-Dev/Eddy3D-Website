...
- **Current version:** `1.0.8.827` (July 13, 2026)
...
| --- | --- | --- | --- | --- | --- | --- |
| Stable release | `1.0.8.827` | July 13, 2026 | Windows / Mac | 8.27 | [Install via Rhino Package Manager](https://rhinopackages.github.io/?search=eddy3d&sort=2&p=Eddy3D){ aria-label="Install Eddy3D 1.0.8.827 via the Rhino Package Manager" } | [Changelog](#changelog) |
| Pre-release (beta) | `1.0.7-beta.827` | July 13, 2026 | Windows / Mac | 8.27 | [Install via Rhino Package Manager](https://rhinopackages.github.io/?search=eddy3d&sort=2&p=Eddy3D){ aria-label="Install Eddy3D 1.0.7-beta.827 via the Rhino Package Manager" } | Tick *Include pre-releases* in the Package Manager |
