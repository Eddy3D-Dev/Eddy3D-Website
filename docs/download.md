...
| Pre-release (beta) | `1.5.0-beta.827` | August 7, 2026 | Windows / Mac | 8.27 | [Install via Rhino Package Manager](https://rhinopackages.github.io/?search=eddy3d&sort=2&p=Eddy3D){ aria-label="Install Eddy3D 1.5.0-beta.827 via the Rhino Package Manager" } | Tick *Include pre-releases* in the Package Manager |
