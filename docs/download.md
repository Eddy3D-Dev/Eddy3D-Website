...
- **Current version:** `1.7.0.827` (August 13, 2026)
...
| --- | --- | --- | --- | --- | --- | --- |
| Stable release | `1.7.0.827` | August 13, 2026 | Windows / Mac | 8.27 | [Install via Rhino Package Manager](https://rhinopackages.github.io/?search=eddy3d&sort=2&p=Eddy3D){ aria-label="Install Eddy3D 1.7.0.827 via the Rhino Package Manager" } | [Changelog](#changelog) |
